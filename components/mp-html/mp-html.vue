...
// #endif
const plugins=[require('./markdown/index.js'),require('./audio/index.js'),require('./emoji/index.js'),require('./highlight/index.js'),require('./search/index.js'),require('./img-cache/index.js'),]
