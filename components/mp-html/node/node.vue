...
<style>/deep/ .hl-code,/deep/ .hl-pre{color:#f8f8f2;background:0 0;text-shadow:0 1px rgba(0,0,0,.3);font-family:Consolas,Monaco,'Andale Mono','Ubuntu Mono',monospace;font-size:1em;text-align:left;white-space:pre;word-spacing:normal;word-break:normal;word-wrap:normal;line-height:1.5;-moz-tab-size:4;-o-tab-size:4;tab-size:4;-webkit-hyphens:none;-moz-hyphens:none;-ms-hyphens:none;hyphens:none}/deep/ .hl-pre{padding:1em;margin:.5em 0;overflow:auto;border-radius:.3em}/deep/ .hl-pre{background:#272822}/deep/ .hl-cdata,/deep/ .hl-comment,/deep/ .hl-doctype,/deep/ .hl-prolog{color:#8292a2}/deep/ .hl-punctuation{color:#f8f8f2}/deep/ .hl-namespace{opacity:.7}/deep/ .hl-constant,/deep/ .hl-deleted,/deep/ .hl-property,/deep/ .hl-symbol,/deep/ .hl-tag{color:#f92672}/deep/ .hl-boolean,/deep/ .hl-number{color:#ae81ff}/deep/ .hl-attr-name,/deep/ .hl-builtin,/deep/ .hl-char,/deep/ .hl-inserted,/deep/ .hl-selector,/deep/ .hl-string{color:#a6e22e}/deep/ .hl-entity,/deep/ .hl-operator,/deep/ .hl-url,/deep/ .hl-variable,/deep/ .language-css .hl-string,/deep/ .style .hl-string{color:#f8f8f2}/deep/ .hl-atrule,/deep/ .hl-attr-value,/deep/ .hl-class-name,/deep/ .hl-function{color:#e6db74}/deep/ .hl-keyword{color:#66d9ef}/deep/ .hl-important,/deep/ .hl-regex{color:#fd971f}/deep/ .hl-bold,/deep/ .hl-important{font-weight:700}/deep/ .hl-italic{font-style:italic}/deep/ .hl-entity{cursor:help}/deep/ .md-p {
