...
/***/ 79:
/*!***********************************************************!*\
  !*** D:/WordPress/main.js?{"page":"pages%2Flist%2Flist"} ***!
  \***********************************************************/
...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/list/list.vue */ 80));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/***/ 80:
/*!****************************************!*\
  !*** D:/WordPress/pages/list/list.vue ***!
  \****************************************/
/*! no static exports found */
...
/* harmony import */ var _list_vue_vue_type_template_id_7d5e07c6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=7d5e07c6& */ 81);
...
/* harmony import */ var _list_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list.vue?vue&type=style&index=0&lang=css& */ 85);
...
/***/ 81:
/*!***********************************************************************!*\
  !*** D:/WordPress/pages/list/list.vue?vue&type=template&id=7d5e07c6& ***!
  \***********************************************************************/
...
/***/ 82:
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/WordPress/pages/list/list.vue?vue&type=template&id=7d5e07c6& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 83:
/*!*****************************************************************!*\
  !*** D:/WordPress/pages/list/list.vue?vue&type=script&lang=js& ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 84:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/WordPress/pages/list/list.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _config = _interopRequireDefault(__webpack_require__(/*! ../../utils/config */ 32));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
 ...
 */var Api = __webpack_require__(/*! ../../utils/api.js */ 33);var util = __webpack_require__(/*! ../../utils/util.js */ 34);var wxApi = __webpack_require__(/*! ../../utils/wxApi.js */ 35);var Adapter = __webpack_require__(/*! ../../utils/adapter.js */ 37);var wxRequest = __webpack_require__(/*! ../../utils/wxRequest.js */ 36);var pageCount = _config.default.getPageCount;var webSiteName = _config.default.getWebsiteName;var domain = _config.default.getDomain;var _default = { data: function data() {return { title: '文章列表', postsList: {}, pagesList: {}, categoriesList: {}, postsShowSwiperList: {}, isLastPage: false, page: 1, search: '', categories: 0, categoriesName: '', categoriesImage: "", showerror: "none", isCategoryPage: "none", isSearchPage: "none", showallDisplay: "block", displaySwiper: "block", floatDisplay: "none", searchKey: "", webSiteName: webSiteName, domain: domain, listAdsuccess: true, isLoading: false };}, components: {}, props: {}, onShareAppMessage: function onShareAppMessage() {var title = "分享“" + webSiteName + "”";var path = "";if (this.categories && this.categories != 0) {title += "的专题：" + this.categoriesList.name;path = 'pages/list/list?categoryID=' + this.categoriesList.id;} else {title += "的搜索内容：" + this.searchKey;path = 'pages/list/list?search=' + this.searchKey;}return { title: title, path: path, success: function success(res) {// 转发成功
      }, fail: function fail(res) {// 转发失败
      } };}, onReachBottom: function onReachBottom() {var self = this;if (!self.isLastPage) {self.setData({ page: self.page + 1 });console.log('当前页' + self.page);this.fetchPostsData(self);} else {console.log('最后一页');}}, onLoad: function onLoad(options) {var self = this; // 设置插屏广告
    Adapter.setInterstitialAd("enable_list_interstitial_ad");if (options.categoryID && options.categoryID != 0) {self.setData({ categories: options.categoryID, isCategoryPage: "block" });self.fetchCategoriesData(options.categoryID);}if (options.search && options.search != '') {uni.setNavigationBarTitle({ title: "搜索" });self.setData({ search: options.search, isSearchPage: "block", searchKey: options.search });this.fetchPostsData(self);}}, methods: { formSubmit: function formSubmit(e) {var url = '../list/list';if (e.detail.value.input != '') {url = url + '?search=' + e.detail.value.input;}uni.navigateTo({ url: url });}, onShareTimeline: function onShareTimeline() {var path = "";var query = {};var title = "";if (this.categories && this.categories != 0) {title += this.categoriesList.name + "-" + this.categoriesList.description;query = { categoryID: this.categoriesList.id };} else {title += webSiteName + "的搜索内容：" + this.searchKey;query = { search: this.searchKey };}return { title: title, path: 'pages/list/list', query: query, imageUrl: this.categoriesImage };}, reload: function reload(e) {var self = this;if (self.categories && self.categories != 0) {self.setData({ isCategoryPage: "block", showallDisplay: "none", showerror: "none" });self.fetchCategoriesData(self.categories);}if (self.search && self.search != '') {self.setData({
          isSearchPage: "block",
          showallDisplay: "none",
          showerror: "none",
    ...
    //获取文章列表数据
    fetchPostsData: function fetchPostsData(data) {
      var self = this;
      if (!data) data = {};
    ...
    //获取分类列表
    fetchCategoriesData: function fetchCategoriesData(id) {
      var self = this;
      self.setData({
        categoriesList: [] });

      var getCategoryRequest = wxRequest.getRequest(Api.getCategoryByID(id));
      getCategoryRequest.then(function (response) {
        var catImage = "";
        ...
        uni.setNavigationBarTitle({
          ...
          success: function success(res) {// success
          } });
...
/***/ 85:
/*!*************************************************************************!*\
  !*** D:/WordPress/pages/list/list.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 86:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/WordPress/pages/list/list.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
